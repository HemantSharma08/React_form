    ...
    <>
     <div className="App">
      ...
      <fieldset>
        ...
        <input type="text" name='contact' id='contact' value={contact} onChange={(e)=>setContact(e.target.value)} placeholder='Enter email' />
        ...
        <input type="checkbox" name="lang" id="english" checked={subjects.english===true} onChange={()=>handleSubjectChange("english")}/>English        
        <input type="checkbox" name="lang" id="physics" checked={subjects.physics === true} onChange={() =>handleSubjectChange("physics")}/>Physics
        <input type="checkbox" name="lang" id="physics" checked={subjects.maths === true} onChange={() =>handleSubjectChange("maths")}/>Maths
